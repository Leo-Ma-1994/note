...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    /* JADX INFO: Multiple debug info for r4v11 float: [D('deltaCycle' double), D('value' float)] */
    /* access modifiers changed from: package-private */
    public void setView(View view, int[] toUse, double[] data, double[] slope, double[] cycle) {
        ...
        int b = (int) (v_y3 + 0.5f + v_height);
        int i_width = r - l;
        int i_height = b - t;
        if ((i_width == view.getMeasuredWidth() && i_height == view.getMeasuredHeight()) ? false : true) {
            view.measure(View.MeasureSpec.makeMeasureSpec(i_width, BasicMeasure.EXACTLY), View.MeasureSpec.makeMeasureSpec(i_height, BasicMeasure.EXACTLY));
        }
        view.layout(l, t, r, b);
    }
