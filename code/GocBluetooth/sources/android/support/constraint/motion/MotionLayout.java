...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent2 {
    ...
    public void setState(TransitionState newState) {
        if (newState != TransitionState.FINISHED || this.mCurrentState != -1) {
            ...
            int i = AnonymousClass2.$SwitchMap$android$support$constraint$motion$MotionLayout$TransitionState[oldState.ordinal()];
            if (i == 1 || i == 2) {
    ...
    public static /* synthetic */ class AnonymousClass2 {
        static final /* synthetic */ int[] $SwitchMap$android$support$constraint$motion$MotionLayout$TransitionState = new int[TransitionState.values().length];

        static {
            try {
                $SwitchMap$android$support$constraint$motion$MotionLayout$TransitionState[TransitionState.UNDEFINED.ordinal()] = 1;
    ...
    public class Model {
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            String str5 = VCardConstants.PARAM_ENCODING_B;
            String str6 = "__";
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                StringBuilder sb2 = new StringBuilder();
                sb2.append(a);
                sb2.append(child.mBottom.mTarget != null ? VCardConstants.PARAM_ENCODING_B : str2);
                String a2 = sb2.toString();
                StringBuilder sb3 = new StringBuilder();
                sb3.append(a2);
    ...
    @Override // android.support.constraint.ConstraintLayout, android.view.ViewParent, android.view.View
