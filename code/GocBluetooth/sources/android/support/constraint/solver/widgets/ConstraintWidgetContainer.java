...
public class ConstraintWidgetContainer extends WidgetContainer {
    ...
    public boolean addChildrenToSolver(LinearSystem system) {
        ...
        if (LinearSystem.USE_DEPENDENCY_ORDERING) {
            ...
            addChildrenToSolverByDependency(this, system, widgetsToAdd, getHorizontalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT ? 0 : 1, false);
        ...
        if (Optimizer.enabled(this.mOptimizationLevel, 1)) {
            ...
            while (i2 < count2) {
                ...
                if (child.isMeasureRequested() && !(child instanceof Guideline) && !(child instanceof Barrier) && !(child instanceof VirtualLayout) && !child.isInVirtualLayout()) {
                    if (!(child.getDimensionBehaviour(i) == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && child.mMatchConstraintDefaultWidth != 1 && child.getDimensionBehaviour(1) == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && child.mMatchConstraintDefaultHeight != 1)) {
