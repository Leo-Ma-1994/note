...
public class HorizontalChainReference extends ChainReference {
    ...
    public void apply() {
        ...
        int i = AnonymousClass1.$SwitchMap$android$support$constraint$solver$state$State$Chain[this.mStyle.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$android$support$constraint$solver$state$State$Chain = new int[State.Chain.values().length];

        static {
            try {
                $SwitchMap$android$support$constraint$solver$state$State$Chain[State.Chain.SPREAD.ordinal()] = 1;
