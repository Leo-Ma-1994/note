...
public class State {
    ...
    public HelperReference helper(Object key, Helper type) {
        ...
        if (reference == null) {
            int i = AnonymousClass1.$SwitchMap$android$support$constraint$solver$state$State$Helper[type.ordinal()];
            if (i == 1) {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$android$support$constraint$solver$state$State$Helper = new int[Helper.values().length];

        static {
            try {
                $SwitchMap$android$support$constraint$solver$state$State$Helper[Helper.HORIZONTAL_CHAIN.ordinal()] = 1;
