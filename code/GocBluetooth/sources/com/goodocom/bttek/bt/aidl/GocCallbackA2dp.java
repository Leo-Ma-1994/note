...
public interface GocCallbackA2dp extends IInterface {
    ...
    public static abstract class Stub extends Binder implements GocCallbackA2dp {
        private static final String DESCRIPTOR = "com.goodocom.bttek.bt.aidl.GocCallbackA2dp";
        ...
        public static GocCallbackA2dp asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof GocCallbackA2dp)) {
                return new Proxy(obj);
            }
            return (GocCallbackA2dp) iin;
        }
        ...
        public static class Proxy implements GocCallbackA2dp {
            public static GocCallbackA2dp sDefaultImpl;
        ...
        public static boolean setDefaultImpl(GocCallbackA2dp impl) {
        ...
        public static GocCallbackA2dp getDefaultImpl() {
