...
public interface GocCallbackHfp extends IInterface {
    ...
    public static class Default implements GocCallbackHfp {
    ...
    public static abstract class Stub extends Binder implements GocCallbackHfp {
        private static final String DESCRIPTOR = "com.goodocom.bttek.bt.aidl.GocCallbackHfp";
        ...
        public static GocCallbackHfp asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof GocCallbackHfp)) {
                return new Proxy(obj);
            }
            return (GocCallbackHfp) iin;
        }
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 6:
                        ...
                        onHfpRemoteTelecomService(_arg02, _arg12);
                        reply.writeNoException();
                        return true;
                    case 7:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        onHfpRemoteRoamingStatus(_arg03, _arg12);
                        reply.writeNoException();
                        return true;
                    case 8:
                        data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements GocCallbackHfp {
            public static GocCallbackHfp sDefaultImpl;
            ...
            public void onHfpCallingTimeChanged(String var1) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onHfpCallingTimeChanged(var1);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
        ...
        public static boolean setDefaultImpl(GocCallbackHfp impl) {
        ...
        public static GocCallbackHfp getDefaultImpl() {
