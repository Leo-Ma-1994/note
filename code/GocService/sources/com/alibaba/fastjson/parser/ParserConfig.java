...
public class ParserConfig {
    ...
    private ParserConfig(ASMDeserializerFactory asmFactory2, ClassLoader parentClassLoader) {
        ...
        if (asmFactory2 == null) {
            if (parentClassLoader == null) {
                try {
                    asmFactory2 = ASMDeserializerFactory.getInstance();
    ...
    public ObjectDeserializer createJavaBeanDeserializer(Class<?> clazz, Type type) {
        ...
        boolean asmEnable2 = this.asmEnable;
        if (asmEnable2) {
        ...
        if (asmEnable2 && (aSMDeserializerFactory = this.asmFactory) != null && aSMDeserializerFactory.isExternalClass(clazz)) {
            asmEnable2 = false;
        }
        if (asmEnable2) {
            asmEnable2 = ASMUtils.checkName(clazz.getName());
        }
        if (asmEnable2) {
