...
public class FieldInfo implements Comparable<FieldInfo> {
    ...
    public FieldInfo(String name2, Class<?> declaringClass2, Class<?> fieldClass2, Type fieldType2, Field field2) {
        this(name2, declaringClass2, fieldClass2, fieldType2, field2, 0, 0);
    }
    ...
    public FieldInfo(String name2, Method method2, Field field2, int ordinal2, int serialzeFeatures2) {
        this(name2, method2, field2, (Class<?>) null, (Type) null, ordinal2, serialzeFeatures2);
    }
    ...
    public FieldInfo(String name2, Method method2, Field field2, Class<?> clazz, Type type, int ordinal2, int serialzeFeatures2) {
        Class<?> fieldClass2;
        Type fieldType2;
    ...
    public <T extends Annotation> T getAnnotation(Class<T> annotationClass) {
        ...
        Method method2 = this.method;
        if (method2 != null) {
            annotation = (T) method2.getAnnotation(annotationClass);
        }
        return (annotation != null || (field2 = this.field) == null) ? annotation : (T) field2.getAnnotation(annotationClass);
    }
    ...
    public void set(Object javaObject, Object value) throws IllegalAccessException, InvocationTargetException {
        Method method2 = this.method;
        if (method2 != null) {
            method2.invoke(javaObject, value);
        } else {
