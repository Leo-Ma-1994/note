...
public class DbHelperMapCache extends SQLiteOpenHelper {
    ...
    private String TAG = "DbHelperMapCache";
    ...
    public void deleteMessageByMacAddressAndFolder(SQLiteDatabase db, String address, int folder2) {
        db.execSQL("delete from MessageContent where macAddress = ? and folder = ?", new String[]{address, BuildConfig.FLAVOR + folder2});
    }
    ...
    public void deleteMessageByFolderAndHandle(SQLiteDatabase db, String folder2, String handle2, String address) {
