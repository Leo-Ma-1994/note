...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mVoiceWebSearchIntent.addFlags(NfDef.PBAP_PROPERTY_MASK_TIME_STAMP);
        this.mVoiceWebSearchIntent.putExtra("android.speech.extra.LANGUAGE_MODEL", "web_search");
        this.mVoiceAppSearchIntent = new Intent("android.speech.action.RECOGNIZE_SPEECH");
        this.mVoiceAppSearchIntent.addFlags(NfDef.PBAP_PROPERTY_MASK_TIME_STAMP);
    ...
    public void onActionViewExpanded() {
        if (!this.mExpandedInActionView) {
            ...
            this.mSearchSrcTextView.setImeOptions(this.mCollapsedImeOptions | NfDef.PBAP_PROPERTY_MASK_PROID);
            this.mSearchSrcTextView.setText(BuildConfig.FLAVOR);
            setIconified(false);
        }
    }
    ...
    private Intent createIntent(String action, Uri data, String extraData, String query, int actionKey, String actionMsg) {
        ...
        intent.addFlags(NfDef.PBAP_PROPERTY_MASK_TIME_STAMP);
        if (data != null) {
            intent.setData(data);
        }
