...
public class ConstraintWidget {
    ...
    /* JADX INFO: Multiple debug info for r3v2 int: [D('width' int), D('inHorizontalChain' boolean)] */
    ...
    /* JADX INFO: Multiple debug info for r0v6 'beginTarget'  androidx.constraintlayout.solver.SolverVariable: [D('dimension' int), D('beginTarget' androidx.constraintlayout.solver.SolverVariable)] */
    /* JADX INFO: Multiple debug info for r0v7 'beginTarget'  androidx.constraintlayout.solver.SolverVariable: [D('dimension' int), D('beginTarget' androidx.constraintlayout.solver.SolverVariable)] */
    private void applyConstraints(LinearSystem system, boolean parentWrapContent, SolverVariable parentMin, SolverVariable parentMax, DimensionBehaviour dimensionBehaviour, boolean wrapContent, ConstraintAnchor beginAnchor, ConstraintAnchor endAnchor, int beginPosition, int dimension, int minDimension, int maxDimension, float bias, boolean useRatio, boolean inChain, int matchConstraintDefault, int matchMinDimension, int matchMaxDimension, float matchPercentDimension, boolean applyPosition) {
        ...
        if (!variableSize2) {
            ...
            if (matchMaxDimension5 > 0) {
                system.addLowerThan(end2, begin3, matchMaxDimension5, i3);
