...
public class NfDef {
    ...
    public static final String CLASS_SERVICE_A2DP = "com.goodocom.bttek.bt.service.GocServiceA2dp";
    public static final String CLASS_SERVICE_AVRCP = "com.goodocom.bttek.bt.service.GocServiceAvrcp";
    public static final String CLASS_SERVICE_BLUETOOTH = "com.goodocom.bttek.bt.service.GocServiceBluetooth";
    public static final String CLASS_SERVICE_GATT_SERVER = "com.goodocom.bttek.bt.service.GocServiceGattServer";
    public static final String CLASS_SERVICE_HFP = "com.goodocom.bttek.bt.service.GocServiceHfp";
    public static final String CLASS_SERVICE_HID = "com.goodocom.bttek.bt.service.GocServiceHid";
    public static final String CLASS_SERVICE_MAP = "com.goodocom.bttek.bt.service.GocServiceMap";
    public static final String CLASS_SERVICE_OPP = "com.goodocom.bttek.bt.service.GocServiceOpp";
    public static final String CLASS_SERVICE_PBAP = "com.goodocom.bttek.bt.service.GocServicePbap";
    public static final String CLASS_SERVICE_SPP = "com.goodocom.bttek.bt.service.GocServiceSpp";
    ...
    public static final byte[] GATT_DESCRIPTOR_ENABLE_INDICATION_VALUE = {2, 0};
    public static final byte[] GATT_DESCRIPTOR_NOTIFICATION_VALUE = {1, 0};
    ...
    public static final String PACKAGE_NAME = "com.goodocom.bttek";
    ...
    public static final String PBAP_PHOTO_FOLDER = (Environment.getExternalStorageDirectory().getPath() + File.separator + "NfPbapPhoto");
    ...
    public static final ParcelUuid UUID_AdvAudioDist = ParcelUuid.fromString("0000110D-0000-1000-8000-00805F9B34FB");
    public static final ParcelUuid UUID_AudioSink = ParcelUuid.fromString("0000110B-0000-1000-8000-00805F9B34FB");
    public static final ParcelUuid UUID_AudioSource = ParcelUuid.fromString("0000110A-0000-1000-8000-00805F9B34FB");
    public static final ParcelUuid UUID_AvrcpController = ParcelUuid.fromString("0000110E-0000-1000-8000-00805F9B34FB");
    public static final ParcelUuid UUID_AvrcpTarget = ParcelUuid.fromString("0000110C-0000-1000-8000-00805F9B34FB");
    public static final ParcelUuid UUID_BNEP = ParcelUuid.fromString("0000000f-0000-1000-8000-00805F9B34FB");
    public static final ParcelUuid UUID_FTP = ParcelUuid.fromString("00001106-0000-1000-8000-00805F9B34FB");
    public static final ParcelUuid UUID_HSP = ParcelUuid.fromString("00001108-0000-1000-8000-00805F9B34FB");
    public static final ParcelUuid UUID_HSP_AG = ParcelUuid.fromString("00001112-0000-1000-8000-00805F9B34FB");
    public static final ParcelUuid UUID_Handsfree = ParcelUuid.fromString("0000111E-0000-1000-8000-00805F9B34FB");
    public static final ParcelUuid UUID_Handsfree_AG = ParcelUuid.fromString("0000111F-0000-1000-8000-00805F9B34FB");
    public static final ParcelUuid UUID_Hid = ParcelUuid.fromString("00001124-0000-1000-8000-00805f9b34fb");
    public static final ParcelUuid UUID_IAP = ParcelUuid.fromString("00000000-deca-fade-deca-deafdecacafe");
    public static final ParcelUuid UUID_MAP = ParcelUuid.fromString("00001132-0000-1000-8000-00805F9B34FB");
    public static final ParcelUuid UUID_NAP = ParcelUuid.fromString("00001116-0000-1000-8000-00805F9B34FB");
    public static final ParcelUuid UUID_ObexObjectPush = ParcelUuid.fromString("00001105-0000-1000-8000-00805f9b34fb");
    public static final ParcelUuid UUID_PANU = ParcelUuid.fromString("00001115-0000-1000-8000-00805F9B34FB");
    public static final ParcelUuid UUID_PBAP_PSE = ParcelUuid.fromString("0000112f-0000-1000-8000-00805F9B34FB");
    public static final ParcelUuid UUID_SPP = ParcelUuid.fromString("00001101-0000-1000-8000-00805F9B34FB");
