...
public class GocPbapContact implements Parcelable {
    ...
    public GocPbapContact(String bt_address, int storage, String firstName, String middleName, String lastName, int[] phoneType, String[] number, int photoType, byte[] photo, int[] emailType, String[] email, int[] addressType, String[] address, String org) {
