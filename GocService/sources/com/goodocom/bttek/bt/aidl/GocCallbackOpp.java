...
public interface GocCallbackOpp extends IInterface {
    ...
    public static class Default implements GocCallbackOpp {
    ...
    public static abstract class Stub extends Binder implements GocCallbackOpp {
        private static final String DESCRIPTOR = "com.goodocom.bttek.bt.aidl.GocCallbackOpp";
        ...
        public static GocCallbackOpp asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof GocCallbackOpp)) {
                return new Proxy(obj);
            }
            return (GocCallbackOpp) iin;
        }
        ...
        public static class Proxy implements GocCallbackOpp {
            public static GocCallbackOpp sDefaultImpl;
        ...
        public static boolean setDefaultImpl(GocCallbackOpp impl) {
        ...
        public static GocCallbackOpp getDefaultImpl() {
