...
public interface UiCallbackSpp extends IInterface {
    ...
    public static class Default implements UiCallbackSpp {
    ...
    public static abstract class Stub extends Binder implements UiCallbackSpp {
        private static final String DESCRIPTOR = "com.goodocom.bttek.bt.aidl.UiCallbackSpp";
        ...
        public static class Proxy implements UiCallbackSpp {
            public static UiCallbackSpp sDefaultImpl;
        ...
        public static boolean setDefaultImpl(UiCallbackSpp impl) {
        ...
        public static UiCallbackSpp getDefaultImpl() {
