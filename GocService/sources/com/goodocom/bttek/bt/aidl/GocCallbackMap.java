...
public interface GocCallbackMap extends IInterface {
    ...
    public static class Default implements GocCallbackMap {
    ...
    public static abstract class Stub extends Binder implements GocCallbackMap {
        private static final String DESCRIPTOR = "com.goodocom.bttek.bt.aidl.GocCallbackMap";
        ...
        public static GocCallbackMap asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof GocCallbackMap)) {
                return new Proxy(obj);
            }
            return (GocCallbackMap) iin;
        }
        ...
        public static class Proxy implements GocCallbackMap {
            public static GocCallbackMap sDefaultImpl;
        ...
        public static boolean setDefaultImpl(GocCallbackMap impl) {
        ...
        public static GocCallbackMap getDefaultImpl() {
