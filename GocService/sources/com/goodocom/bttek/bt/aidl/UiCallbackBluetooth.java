...
public interface UiCallbackBluetooth extends IInterface {
    ...
    void onLocalAdapterPinCodeChanged(String str) throws RemoteException;
    ...
    public static class Default implements UiCallbackBluetooth {
    ...
    public static abstract class Stub extends Binder implements UiCallbackBluetooth {
        private static final String DESCRIPTOR = "com.goodocom.bttek.bt.aidl.UiCallbackBluetooth";
        ...
        static final int TRANSACTION_onAutoAnwer = 21;
        static final int TRANSACTION_onAutoConnect = 20;
        ...
        static final int TRANSACTION_onConnectedDevice = 22;
        ...
        static final int TRANSACTION_onLocalAdapterPinCodeChanged = 18;
        static final int TRANSACTION_onMainDevicesChanged = 19;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 18:
                        data.enforceInterface(DESCRIPTOR);
                        onLocalAdapterPinCodeChanged(data.readString());
                        reply.writeNoException();
                        return true;
                    case 19:
                        data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements UiCallbackBluetooth {
            public static UiCallbackBluetooth sDefaultImpl;
            ...
            public void onLocalAdapterPinCodeChanged(String key) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onLocalAdapterPinCodeChanged(key);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
            ...
            public void onMainDevicesChanged(String addr, String name) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onMainDevicesChanged(addr, name);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
        ...
        public static boolean setDefaultImpl(UiCallbackBluetooth impl) {
        ...
        public static UiCallbackBluetooth getDefaultImpl() {
