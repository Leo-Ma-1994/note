            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 123:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_isHfpInBandRingtoneSupport /* 124 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 125:
                        ...
                        return true;
                    case TRANSACTION_unregisterPbapCallback /* 126 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 150:
                        ...
                        return true;
                    case TRANSACTION_unregisterHidCallback /* 151 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_reqSendHidMouseCommand /* 157 */:
                        ...
                        return true;
                    case TRANSACTION_reqSendHidVirtualKeyCommand /* 158 */:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_registerMapCallback /* 159 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 160:
                        ...
                        return true;
                    case TRANSACTION_reqMapDownloadSingleMessage /* 161 */:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_reqMapDownloadMessage /* 162 */:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_reqMapRegisterNotification /* 163 */:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_reqMapUnregisterNotification /* 164 */:
                        data.enforceInterface(DESCRIPTOR);
                        reqMapUnregisterNotification(data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_isMapNotificationRegistered /* 165 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_getMapRegisterState /* 171 */:
                        ...
                        return true;
                    case TRANSACTION_reqMapSendMessage /* 172 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_setMapDownloadNotify /* 175 */:
                        ...
                        return true;
                    case TRANSACTION_setDefaultPinCode /* 176 */:
                        data.enforceInterface(DESCRIPTOR);
                        setDefaultPinCode(data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getDefaultPinCode /* 177 */:
                        data.enforceInterface(DESCRIPTOR);
                        String _result35 = getDefaultPinCode();
                        reply.writeNoException();
                        reply.writeString(_result35);
                        return true;
                    case TRANSACTION_setBtAutoAcceptPairingRequest /* 178 */:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg05 = true;
                        }
                    ...
                    case TRANSACTION_registerOppCallback /* 180 */:
                        ...
                        return true;
                    case TRANSACTION_unregisterOppCallback /* 181 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_reqOppAcceptReceiveFile /* 184 */:
                        ...
                        return true;
                    case TRANSACTION_reqOppInterruptReceiveFile /* 185 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_setTargetAddress /* 186 */:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getTargetAddress /* 187 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_unregisterGattServerCallback /* 191 */:
                        ...
                        return true;
                    case TRANSACTION_getGattServerConnectionState /* 192 */:
                        data.enforceInterface(DESCRIPTOR);
                        int _result38 = getGattServerConnectionState();
                        reply.writeNoException();
                        reply.writeInt(_result38);
                        return true;
                    case TRANSACTION_reqGattServerDisconnect /* 193 */:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case TRANSACTION_reqGattServerEndServiceDeclaration /* 197 */:
                        ...
                        return true;
                    case TRANSACTION_reqGattServerRemoveService /* 198 */:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_reqGattServerClearServices /* 199 */:
                        data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements UiCommand {
            ...
            public boolean isHfpInBandRingtoneSupport() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_isHfpInBandRingtoneSupport, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean unregisterPbapCallback(UiCallbackPbap cb) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(cb != null ? cb.asBinder() : null);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_unregisterPbapCallback, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean reqSppDisconnect(String address) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(address);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_reqSppDisconnect, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public void reqSppConnectedDeviceAddressList() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (this.mRemote.transact(Stub.TRANSACTION_reqSppConnectedDeviceAddressList, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public boolean isSppConnected(String address) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(address);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_isSppConnected, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public void reqSppSendData(String address, byte[] sppData) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_reqSppSendData, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public boolean unregisterHidCallback(UiCallbackHid cb) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(cb != null ? cb.asBinder() : null);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_unregisterHidCallback, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public int getHidConnectionState() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.mRemote.transact(Stub.TRANSACTION_getHidConnectionState, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean isHidConnected() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_isHidConnected, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public String getHidConnectedAddress() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.mRemote.transact(Stub.TRANSACTION_getHidConnectedAddress, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean reqHidConnect(String address) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(address);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_reqHidConnect, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean reqHidDisconnect(String address) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(address);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_reqHidDisconnect, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean reqSendHidMouseCommand(int button, int offset_x, int offset_y, int wheel) throws RemoteException {
                ...
                try {
                    ...
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_reqSendHidMouseCommand, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean reqSendHidVirtualKeyCommand(int key_1, int key_2) throws RemoteException {
                ...
                try {
                    ...
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_reqSendHidVirtualKeyCommand, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean registerMapCallback(UiCallbackMap cb) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(cb != null ? cb.asBinder() : null);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_registerMapCallback, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean reqMapDownloadSingleMessage(String address, int folder, String handle, int storage) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(storage);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_reqMapDownloadSingleMessage, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean reqMapDownloadMessage(String address, int folder, boolean isContentDownload, int count, int startPos, int storage, String periodBegin, String periodEnd, String sender, String recipient, int readStatus, int typeFilter) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(Stub.TRANSACTION_reqMapDownloadMessage, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean reqMapRegisterNotification(String address, boolean downloadNewMessage) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(Stub.TRANSACTION_reqMapRegisterNotification, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public void reqMapUnregisterNotification(String address) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(address);
                    if (this.mRemote.transact(Stub.TRANSACTION_reqMapUnregisterNotification, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public boolean isMapNotificationRegistered(String address) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(address);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_isMapNotificationRegistered, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean reqMapDownloadInterrupt(String address) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(address);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_reqMapDownloadInterrupt, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public void reqMapDatabaseAvailable() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (this.mRemote.transact(Stub.TRANSACTION_reqMapDatabaseAvailable, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public void reqMapDeleteDatabaseByAddress(String address) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(address);
                    if (this.mRemote.transact(Stub.TRANSACTION_reqMapDeleteDatabaseByAddress, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public void reqMapCleanDatabase() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (this.mRemote.transact(Stub.TRANSACTION_reqMapCleanDatabase, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public boolean reqMapSendMessage(String address, String message, String target) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(target);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_reqMapSendMessage, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public void setDefaultPinCode(String pinCode) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_setDefaultPinCode, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public String getDefaultPinCode() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.mRemote.transact(Stub.TRANSACTION_getDefaultPinCode, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public void setBtAutoAcceptPairingRequest(boolean auto) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_setBtAutoAcceptPairingRequest, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public boolean isBtAutoAcceptPairingRequest() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_isBtAutoAcceptPairingRequest, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean registerOppCallback(UiCallbackOpp cb) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(cb != null ? cb.asBinder() : null);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_registerOppCallback, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean unregisterOppCallback(UiCallbackOpp cb) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeStrongBinder(cb != null ? cb.asBinder() : null);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_unregisterOppCallback, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean setOppFilePath(String path) throws RemoteException {
                ...
                try {
                    ...
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_setOppFilePath, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public String getOppFilePath() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.mRemote.transact(Stub.TRANSACTION_getOppFilePath, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean reqOppAcceptReceiveFile(boolean accept) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(Stub.TRANSACTION_reqOppAcceptReceiveFile, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean reqOppInterruptReceiveFile() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_reqOppInterruptReceiveFile, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public String getTargetAddress() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.mRemote.transact(Stub.TRANSACTION_getTargetAddress, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public int getGattServerConnectionState() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.mRemote.transact(Stub.TRANSACTION_getGattServerConnectionState, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean reqGattServerDisconnect(String address) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(address);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_reqGattServerDisconnect, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean reqGattServerRemoveService(int srvcType, ParcelUuid srvcUuid) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(Stub.TRANSACTION_reqGattServerRemoveService, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
            ...
            public boolean reqGattServerClearServices() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    boolean _result = false;
                    if (!this.mRemote.transact(Stub.TRANSACTION_reqGattServerClearServices, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
