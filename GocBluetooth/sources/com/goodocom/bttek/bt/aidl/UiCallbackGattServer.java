...
public interface UiCallbackGattServer extends IInterface {
    ...
    public static class Default implements UiCallbackGattServer {
    ...
    public static abstract class Stub extends Binder implements UiCallbackGattServer {
        private static final String DESCRIPTOR = "com.goodocom.bttek.bt.aidl.UiCallbackGattServer";
        ...
        public static class Proxy implements UiCallbackGattServer {
            public static UiCallbackGattServer sDefaultImpl;
        ...
        public static boolean setDefaultImpl(UiCallbackGattServer impl) {
        ...
        public static UiCallbackGattServer getDefaultImpl() {
