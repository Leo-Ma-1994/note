...
public interface GocCallbackAvrcp extends IInterface {
    ...
    public static class Default implements GocCallbackAvrcp {
    ...
    public static abstract class Stub extends Binder implements GocCallbackAvrcp {
        private static final String DESCRIPTOR = "com.goodocom.bttek.bt.aidl.GocCallbackAvrcp";
        ...
        static final int TRANSACTION_retAvrcpPlayModeChanged = 36;

        public Stub() {
            attachInterface(this, DESCRIPTOR);
        }

        public static GocCallbackAvrcp asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof GocCallbackAvrcp)) {
                return new Proxy(obj);
            }
            return (GocCallbackAvrcp) iin;
        }
        ...
        public static class Proxy implements GocCallbackAvrcp {
            public static GocCallbackAvrcp sDefaultImpl;
        ...
        public static boolean setDefaultImpl(GocCallbackAvrcp impl) {
        ...
        public static GocCallbackAvrcp getDefaultImpl() {
