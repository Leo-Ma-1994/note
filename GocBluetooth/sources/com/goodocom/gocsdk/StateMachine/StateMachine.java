...
import com.goodocom.gocsdk.StateMachine.StateMachine;
...
public class StateMachine {
    ...
    public static class SmHandler extends Handler {
        ...
        public class HaltingState extends State {
            ...
            @Override // com.goodocom.gocsdk.StateMachine.State, com.goodocom.gocsdk.StateMachine.IState
        ...
        private void removeState(State state) {
            ...
            if (stateInfo != null && !stateInfo.active && !this.mStateInfo.values().stream().filter(new Predicate() {
                /* class com.goodocom.gocsdk.StateMachine.$$Lambda$StateMachine$SmHandler$K7YTq3uFNLT11QUSZhJHBwE5Hx0 */
